...
// Recursive helper function to traverse the tree and capture the left view
public static void helper(TreeNode node, int level, List<Integer> ans) {
    ...
    // Traverse the left subtree first, then the right subtree (for left view)
...
public class left_view {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Print the left side view of the tree
        leftSideView(root);
    }
}
